...
import com.codingbox.jpaitem.embedded.Orders;

/*
 * 2-2. testMain2 수행시 com.codingbox.jpaitem.embedded 에 있는 Member, Orders 엔티티 활성화
 * (com.codingbox.jpatest.domain 에 있는 Member, Orders 엔티티 비활성화(주석) )
 */
